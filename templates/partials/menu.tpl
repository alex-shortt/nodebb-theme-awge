				...
				<a href="<!-- IF title:url -->{title:url}<!-- ELSE -->{relative_path}/<!-- ENDIF title:url -->" class="awge-navbar-program">
					<img class="awge-navbar-starticon hidden-xs" src="https://dwvo2npct47gg.cloudfront.net/images/awge-start.png">
					<h1 class="navbar-brand forum-title awge-navbar-title">{config.siteTitle}</h1>
				</a>
			...
			<div id="nav-dropdown" class="hidden-xs awge-navbar-dropdown">
				...
				<ul id="main-nav" class="nav navbar-nav">
					...
					<li class="{navigation.class} awge-navbar-program">
				...
				<ul id="logged-in-menu" class="nav navbar-nav awge-navbar-loggedin">
					<li class="notifications dropup text-center hidden-xs awge-navbar-program" component="notifications">
					...
					<li class="chats dropup awge-navbar-program">
					...
					<li id="user_label" class="dropup awge-navbar-program">
						<label for="user-control-list-check" class="dropdown-toggle awge-navbar-usericon" data-toggle="dropdown" id="user_dropdown" title="[[global:header.profile]]" role="button">
							<!-- IF user.picture -->
				...
				<ul class="nav navbar-nav hidden-xs">
					<li class="awge-navbar-reconnect">
				...
				<!--
				<ul class="nav navbar-nav pagination-block visible-lg visible-md awge-navbar-pagination" style="margin:0 !important;">
					<li class="dropup">
				...
				<div class="nav navbar-nav awge-navbar-dock">
			...
			<div class="nav navbar-nav awge-navbar-clock awge-navbar-program active visible-lg">
				<p id="awge_clock">4:20 AM</p>
			</div>
