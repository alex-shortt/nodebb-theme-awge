...
<div class="unread awge-windows">
	<div class="awge-windows-title">
		...
		<h1 class="awge-windows-title-text">Unread</h1>
	</div>
	...
	<ul class="awge-windows-toolbar" component="category/controls">
		...
		<li class="btn-group awge-windows-toolbar-option <!-- IF !topics.length -->hidden<!-- ENDIF !topics.length -->">
	...
	<div class="category">
		<div id="category-no-topics" class="alert alert-warning awge-windows-container <!-- IF topics.length -->hidden<!-- ENDIF topics.length -->">[[unread:no_unread_topics]]</div>
